...
module.exports = {
  ...
  networks: {
    ...
    goerli_testnet: {
      provider: () =>
        new PrivateKeyProvider(privateKey, `https://goerli.infura.io/v3/`),
      network_id: 5,
      skipDryRun: true,
      production: true,
      gasPrice: 128,
    ...
    scroll_alpha_testnet: {
      provider: () =>
        new HDWalletProvider(mnemonic, `https://alpha-rpc.scroll.io/l2`),
      network_id: "*",
      // skipDryRun: true,
      // production: true,
      // gasPrice: 128,
    ...
    ganache: {
      ...
      gasPrice: 128,
      timeoutBlocks: 200,
      from: "0x54C649A3EA598D9B4818F72404bB68fa131e31E7",
