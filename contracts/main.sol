...
contract SHIBLOCK is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibLock";
    string private constant _symbol = "SHIBLOCK";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // check and add to holders array
        if (_balances[to] == 0) {
            allHolders.push(to);
        }
    ...
    function changeFee(uint256 _newFee) external {
        ...
        // require(_newFee <= 15, "Buy/Sell tax must be below %15");
    ...
    function getPercentageOfTotalSupply(
        ...
        return balanceOf(_address).mul(100).div(_tTotal);
    }
}
